var copyrightCampaign = function(options) {
    ...
    function main() {
        $(document).ready(function (e) {
            ...
            var widgetStyle = '<style type="text/css">#copyright-campaign-box { z-index:1000;position:fixed;top:0;left:0;width:100%;height:100%;background:rgb(0,0,0);background:rgba(0,0,0,0.9);text-align:center;font-family:\'Gentium Book Basic\', serif;letter-spacing:0.1em;font-size:1em; } .inner-campaign-box { position:fixed;top:28px;right:28px;bottom:28px;left:28px;color:#EFEFEF;padding:20px;border:5px solid #ffffff; } #corner-close-button { position:fixed;top:8px;right:8px;padding:8px 16px;border-radius:2em;text-decoration:none;border:5px solid #ffffff;color:#ffffff;background:#000000;font-size:1em;font-weight:bold; } #corner-close-button:hover { background:#333333; } #campaign-text-content { position:fixed;top:30%;left:0;width:100%; } #copyright-campaign-box h1 { width:100%;font-family:\'Open Sans\', sans-serif;text-transform:uppercase;font-size:3em;margin: 0 auto 40px auto; } .campaign-text-content div { max-width:25em; padding: 0 30px; margin: 0 auto 40px auto; } #copyright-campaign-box a { color:#aaaacc;text-decoration:none; } #copyright-campaign-box a:hover { color:#ccccee;text-decoration:none; } #copyright-campaign-box .subscribe { font-size:1.5em; } #copyright-campaign-box .credits { position:fixed;bottom:40px;left:0;text-align:center;width:100%; } @media (max-width: 680px) { #copyright-campaign-box, #copyright-campaign-box .subscribe { font-size:1em; } #copyright-campaign-box h1 { font-size:1.5em; } .campaign-text-content { top: 20% } .campaign-text-content div, #copyright-campaign-box h1 { margin-bottom: 20px; } } @media(max-height: 620px) { .campaign-text-content { top: 10%; } .campaign-text-content div, #copyright-campaign-box h1 { margin-bottom: 10px; max-width: 35em } #copyright-campaign-box .credits { position: static;width:auto;max-width:none;} } </style>';

var copyrightCampaign = function(options) {
    ...
    function main() {
        jQuery(document).ready(function (e) {
            jQuery("head").prepend("<link href='" + options.protocol + "://fonts.googleapis.com/css?family=Open+Sans:800|Gentium+Book+Basic' rel='stylesheet' type='text/css'>");
